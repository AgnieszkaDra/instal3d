...
export const navItems: Record<number, OfferNavItem> = {
  ...
  1: { id: 1, label: "Fotowoltaika", href: "/oferta/fotowoltaika/", slug: "fotowoltaika", childrenIds: [8, 9] },
  2: { id: 2, label: "Pompy ciepła", href: "/oferta/pompy-ciepla/", slug: "pompy-ciepla", childrenIds: [10, 11] },
  3: {
    id: 3,
    label: "Klimatyzacja",
  ...
  4: { id: 4, label: "Rekuperacja", href: "/oferta/rekuperacja/", slug: "rekuperacja", childrenIds: [14] },
  5: { id: 5, label: "Hydraulika", href: "/oferta/hydraulika/", slug: "hydraulika", childrenIds: [15] },
  6: { id: 6, label: "Posadzki anhydrytowe", href: "/oferta/posadzki-anhydrytowe/", slug: "posadzki-anhydrytowe", childrenIds: [16] },
  7: { id: 7, label: "Woda lodowa", href: "/oferta/woda-lodowa/", slug: "woda-lodowa" },
